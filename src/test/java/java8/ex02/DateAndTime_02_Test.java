...
public class DateAndTime_02_Test {
    ...
    public void test_localDate_format_with_hour() {
        ...
        localDate.format(DateTimeFormatter.ofPattern("11/03/2015 00:00:00"));
    }
    ...
    public void test_with() {
        ...
        LocalDate result = localDate.withYear(2015).with(ChronoField.MONTH_OF_YEAR, 02).withDayOfMonth(5);
